...
1. Описание проекта
Проект позволяет реализовать операции пополнения и снятия со счета внутри банка Clever - Bank, а также внутрибанковские операции и транзакции между банками.
